...
import {changeEditorConfigCommand, Command, History, pasteCommand} from "../../../model/history";
...
import {EditorConfig, EditorConfigContext, keys} from '../../../config/editor';
...
const Editor = ({shortcuts = shortcutsSingleton}: Props) => {
    ...
    return (
        <EditorConfigContext.Provider value={{
            config: history.editorConfig,
            configure: (changes: Partial<EditorConfig>) => sendCommand(changeEditorConfigCommand(changes)),
        }}>
